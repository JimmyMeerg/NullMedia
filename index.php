<?php
    ...
    if(isset($_POST['login'])){
        ...
        $stmt=$mysqli->prepare("SELECT username, password, id FROM userregistration WHERE username=? and password=? ");
                                    ...
                                    <div class="well row pt-2x pb-3x bk-light">
                                        ...
                                        <div class="col-md-8 col-md-offset-2">
                                            <form action="" class="mt" method="post">
                                                ...
                                                <input type="submit" name="Login" class="btn btn-primary btn-block" value="Login" style="font-size: 20px">
                                            </form>
                                        </div>
                                    </div>
