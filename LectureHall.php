...
<label class="col-sm-2 control-label"> Lecture Hall Name : </label>
<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-2 control-label">Technician in Charge (TIC) : </label>
<div class="col-sm-8">
...
<input type="submit" name="update" Value="Book Now" class="btn btn-primary">
</div>
</form>
