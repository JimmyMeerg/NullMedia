...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fkreserv&table=booking">`fkreserv`.`booking`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fkreserv&table=technician">`fkreserv`.`technician`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fkreserv&table=userregistration">`fkreserv`.`userregistration`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fkreserv&table=room_category">`fkreserv`.`room_category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hostel&table=registration">`hostel`.`registration`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hostel&table=admin">`hostel`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hotel&table=rooms">`hotel`.`rooms`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ngchoonching&table=profile">`ngchoonching`.`profile`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hotel&table=manager">`hotel`.`manager`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=profile&table=ngchoonching">`profile`.`ngchoonching`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
